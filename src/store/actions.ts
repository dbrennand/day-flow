...
export const updateSettings = (payload: DaySettings): AppAction => ({
...
export const setActiveTask = (payload: string | null): AppAction => ({
  type: 'SET_ACTIVE_TASK',
  payload,
})
export const setSettingsOpen = (payload: boolean): AppAction => ({
